...
### What is the Workflow SDK?

The Workflow SDK is a TypeScript framework that adds durability, reliability, and observability to async JavaScript. It enables building apps and AI agents that can suspend, resume, and maintain state with ease.

### Key Features

- ✅ **Durability**: Workflows persist through failures and restarts
- ✅ **Reliability**: Built-in retries and error handling
- ✅ **Observability**: Real-time monitoring and logging
- ✅ **State Management**: Automatic state persistence across workflow steps
...
Visit the [documentation](https://workflow-sdk.dev) for guides and examples.

### Can Workflow SDK be used for AI agents?

Yes! The Workflow SDK is particularly well-suited for AI agents:
- Agents can suspend while waiting for external tool calls
- Memory and conversation state persist across sessions
- Multi-step reasoning workflows are durable and recoverable

### Where can I find help?

- 📖 [Official Docs](https://workflow-sdk.dev)
