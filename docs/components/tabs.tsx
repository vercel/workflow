...
export function Tabs({
  ...
  return (
    <Unstyled.Tabs
      ref={ref}
      className={cn(
        'flex flex-col overflow-hidden rounded-md border my-4',
        className
      )}
      value={value}
...
export function TabsContent({
  ...
  return (
    <Unstyled.TabsContent
      ...
      forceMount
      className={cn(
        'p-4 text-[15px] bg-fd-background rounded-md outline-none prose-no-margin data-[state=inactive]:hidden [&>figure:only-child]:-my-4 [&>figure:only-child]:border-none',
        className
      )}
      {...props}
    >
