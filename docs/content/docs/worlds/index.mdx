...
import { WorldsDashboard } from '@/components/worlds';
import worldsData from '@/public/data/worlds-status.json';
...
<WorldsDashboard data={worldsData} />
...
2. Publish to npm
3. Open a PR to add your world to `community-worlds.json`
