...
<Callout type="info">
AI models don't need a factory when you use Vercel AI Gateway. Pass a serializable model string such as `"zai/glm-5.2"` to AI SDK instead of constructing a provider object.
</Callout>
