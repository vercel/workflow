...
When integration tests fail, the [Workflow SDK CLI and Web UI](/docs/observability/overview) can help you inspect what happened. Because integration tests persist workflow state locally, you can use the same observability tools you would use in development.
...
<Callout type="info">
See the [Observability](/docs/observability/overview) docs for the full set of CLI commands and Web UI features.
</Callout>
...
- [Observability](/docs/observability/overview) - Inspect and debug workflow runs with the CLI and Web UI
