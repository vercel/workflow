...
- **Workers + task queues.** Managed deployments replace workers; self-hosted deployments still need a `World` implementation (see [/worlds/building-a-world](/worlds/building-a-world)).
