...
| **Pricing** | SDK free; pay your platform | Workers Standard: requests + CPU-time + storage (idle/sleep not billed) |
...
---
*Compiled from public documentation as of June 2026. Verify current Cloudflare Workflows limits and pricing against [developers.cloudflare.com/workflows](https://developers.cloudflare.com/workflows/). Not based on head-to-head benchmarks.*
