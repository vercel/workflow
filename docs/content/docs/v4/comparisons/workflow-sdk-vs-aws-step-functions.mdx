...
| **Pricing** | SDK free; pay your platform | **Standard:** $0.025 / 1K state transitions (4K/mo free forever). **Express:** $1 / M requests + GB-second duration |
| **Limits** | 50 MB payload; 2 GB/run; no duration cap | 256 KB payload between states; Standard 25K history events / 1 year; Express 5 minutes |
...
| **Maturity** | v4 GA / v5 beta | GA since 2016 — very mature, heavy AWS adoption |
...
---
*Compiled from public documentation as of June 2026. Step Functions pricing/limits are region-specific (figures are us-east-1); verify against [the AWS pricing page](https://aws.amazon.com/step-functions/pricing/). Not based on head-to-head benchmarks.*
