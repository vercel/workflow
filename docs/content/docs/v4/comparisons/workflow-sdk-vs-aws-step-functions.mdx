...
| **Maturity** | Built and maintained by Vercel | Very mature; heavy AWS adoption |
...
These are Step Functions capabilities that the Workflow SDK does not replicate one-to-one — here's how to cover each on the Workflow SDK side:
