...
| **Compliance** | Inherits your platform | HIPAA-eligible; SOC/PCI/ISO and other programs are under internal assessment with third-party audits pending (FedRAMP not yet authorized for AgentCore) |
...
| **Maturity** | v4 GA / v5 beta | Core platform GA since October 2025; newer modules (Harness, Policy, Evaluations) reached GA in 2026 |
...
---
*Compiled from public documentation as of July 2026. AgentCore cold-start figures are community-sourced (no published SLA), and its module lineup and compliance certifications are evolving. Verify against [the AgentCore docs](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/what-is-bedrock-agentcore.html). Not based on head-to-head benchmarks.*
