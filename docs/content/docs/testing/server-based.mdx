...
type: conceptual
summary: Run integration tests against an actual dev server for full-stack workflow testing.
prerequisites:
  - /docs/testing
...
Tests are written the same way as [in-process integration tests](/docs/testing#writing-integration-tests):
