...
- The child workflow is short-lived

**Choose background execution when:**
- The child workflow is long-running
- The parent doesn't need to wait for the result
- You want independent retry and failure handling
- You need to track the child workflow separately
