...
related:
  - /docs/api-reference/workflow/errors/fatal-error
  - /docs/api-reference/workflow/errors/retryable-error
---
...
When your step needs to intentionally throw an error and skip retrying, simply throw a [`FatalError`](/docs/api-reference/workflow/errors/fatal-error).
...
When you need to customize the delay on a retry, use [`RetryableError`](/docs/api-reference/workflow/errors/retryable-error) and set the `retryAfter` property.
