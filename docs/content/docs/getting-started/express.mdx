...
<Tabs items={["npm", "pnpm", "yarn"]}>
  <Tab value="npm">
    <CodeBlock>npm i workflow express nitro rollup</CodeBlock>
  </Tab>
  <Tab value="pnpm">
    <CodeBlock>pnpm i workflow express nitro rollup</CodeBlock>
  </Tab>
  <Tab value="yarn">
    <CodeBlock>yarn add workflow express nitro rollup</CodeBlock>
  </Tab>
</Tabs>
...
import exprimport express from "express";
