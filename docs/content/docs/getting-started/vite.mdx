...
<Tabs items={['npm', 'pnpm', 'yarn']}>
  <Tab value="npm">
    <CodeBlock>
        npm i workflow nitro@npm:nitro-nightly@latest
    </CodeBlock>
  </Tab>
  <Tab value="pnpm">
    <CodeBlock>
        pnpm i workflow nitro@npm:nitro-nightly@latest
    </CodeBlock>
  </Tab>
  <Tab value="yarn">
    <CodeBlock>
        yarn add workflow nitro@npm:nitro-nightly@latest
    </CodeBlock>
  </Tab>
</Tabs>
...
To invoke your new workflow, we'll have to add your workflow to a `POST` API route handler, `src/routes/api/signup.post.ts` with the following code:

```typescript title="src/routes/api/signup.post.ts"
