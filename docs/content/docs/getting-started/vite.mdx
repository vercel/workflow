...
<Tabs items={['npm', 'pnpm', 'yarn']}>
  <Tab value="npm">
    <CodeBlock>
        npm i workflow nitro@npm:nitro-nightly@3.0.1-20251031-202656-883af4f9
    </CodeBlock>
  </Tab>
  <Tab value="pnpm">
    <CodeBlock>
        pnpm i workflow nitro@npm:nitro-nightly@3.0.1-20251031-202656-883af4f9
    </CodeBlock>
  </Tab>
  <Tab value="yarn">
    <CodeBlock>
        yarn add workflow nitro@npm:nitro-nightly@3.0.1-20251031-202656-883af4f9
    </CodeBlock>
  </Tab>
</Tabs>
