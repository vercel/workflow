...
Start by creating a new Nitro project. This command will create a new directory named `nitro-appp` and setup a Nitro project inside it.
...
```bash
npx wf i runs # add '--web' for an interactive Web based UI
```
