...
Start by creating a new Hono project. This command will create a new directory named `my-workflow-app` and setup a Hono project inside it.
...
<Tabs items={["npm", "pnpm", "yarn"]}>
  <Tab value="npm">
    <CodeBlock>npm i workflow nitro</CodeBlock>
  </Tab>
  <Tab value="pnpm">
    <CodeBlock>pnpm i workflow nitro</CodeBlock>
  </Tab>
  <Tab value="yarn">
    <CodeBlock>yarn add workflow nitro</CodeBlock>
  </Tab>
</Tabs>

<Callout>
Hono doesn't include a build system. Nitro adds one which enables compiling workflows, runs, and deploys for development and production. Learn more about Nitro [here](https://nitro.build).
</Callout>
...
To use the Nitro adapter, update your `package.json` to include the following scripts:
