...
The Vercel environment to target. Options: `production`, `preview`, `development`. Default: `production`.
...
Options passed to `createVercelWorld()` take precedence over the environment variables above:
