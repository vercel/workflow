...
Testing-only JSON object forwarded to workflow-server to tighten server-side limits on dedicated test deployments. Default: unset. Do not set this in production.
