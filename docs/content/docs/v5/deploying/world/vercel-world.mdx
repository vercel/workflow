...
Vercel Queues supports longer delays, but messages have a default TTL of 24 hours unless a custom retention window is set. Workflow uses a 23-hour continuation hop to stay safely inside that default.
