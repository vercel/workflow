...
- **Multi-region** - Runs are pinned to the region that creates them, keeping workflow data, execution, and streaming close to your users (requires `workflow` 5.0.0-beta.33 or later)
