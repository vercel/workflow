...
You can inspect local workflow data using the Workflow CLI:
...
The [Observability tools](/docs/observability) work with any World backend. By default, the tools connect to your local environment, but you can configure them to inspect remote deployments:
