...
Anything not listed in this section or on a World page, such as `WORKFLOW_NEXT_PRIVATE_BUILT`, `WORKFLOW_NODE_COMPAT_BANNER`, or `WORKFLOW_SOCKET_*`, is internal to the SDK.
