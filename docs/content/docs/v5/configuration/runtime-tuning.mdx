...
- Default: `25000`
- Positive-integer event limit used by the Local World. When the runtime requests a complete replay log, the Local and Postgres Worlds also use it as the maximum page size.
