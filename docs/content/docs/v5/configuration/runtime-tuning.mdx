...
- Step inputs containing accessors, proxies, functions, custom class serializers, or other values whose serialization could execute workflow code also fall back to replay. Plain data and standard in-memory collections remain retainable.
