...
- Environment variable: none
- Default: `20`
- Number of items returned per page for list commands. Must be an integer between 1 and 1000. Individual listings cap lower than that — a cross-run listing allows fewer rows than one scoped to a single run — and report the limit they accept when you exceed it.
