...
- **Support for more frameworks.** [React Router](/docs/getting-started/react-router) (v7 and v8, via Nitro) is now supported, and [NestJS](/docs/getting-started/nestjs) and [Python](/docs/getting-started/python) workflows are in beta.
