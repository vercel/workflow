...
Keep `dirs: ["workflows"]` so subsequent builds do not scan generated files under `build`. Preserve the relative order of the three plugins; any other Vite plugins can remain.
