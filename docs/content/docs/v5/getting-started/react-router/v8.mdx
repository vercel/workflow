...
This guide starts with an existing React Router v8 framework-mode app. You will add Nitro as the server, connect React Router's server build to it, and enable Workflow SDK.
