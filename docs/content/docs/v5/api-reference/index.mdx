...
<Cards>
    <Card title="Python SDK" href="/docs/api-reference/python">
        Python APIs from the `vercel-workflow` package, including workflow and step registration, runs, hooks, streams, metadata, serialization, and errors.
    </Card>
