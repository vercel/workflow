...
Step input/output data is serialized using the [devalue](https://github.com/Rich-Harris/devalue) format. To display this data in your user interface, use the hydration utilities from `workflow/observability`:
