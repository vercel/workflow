...
The prefix is a plain path of one or more segments. Leading and trailing slashes are optional, and dynamic segments such as `/[team]` are rejected because the generated routes have to sit at a fixed, addressable path.
