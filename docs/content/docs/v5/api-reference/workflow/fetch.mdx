...
This API is provided as a convenience to use `fetch` in workflow, but often, you might want to extend and implement your own fetch for more powerful error handing and retry logic.
