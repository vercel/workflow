...
Native attributes require spec version 4 or later. Storage errors throw from `experimental_setAttributes`; catch them inside a step if the write should be best-effort.
