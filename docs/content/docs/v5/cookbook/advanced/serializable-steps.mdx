...
If you intentionally authenticate with a provider directly, construct and use its model inside the step. The outer factory captures only the serializable model ID:
