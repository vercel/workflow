...
Unlike regular values that are fully serialized to the [event log](/docs/advanced/event-sourcing), streams maintain their streaming capabilities when passed between functions.
