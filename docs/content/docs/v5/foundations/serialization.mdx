...
- <LanguageContent value="ts" inline>Class instances that implement [`WORKFLOW_SERIALIZE` and `WORKFLOW_DESERIALIZE`](#custom-class-serialization)</LanguageContent><LanguageContent value="py" inline>Pydantic models, dataclasses, and classes registered with [`@serializable`](#custom-class-serialization)</LanguageContent>
