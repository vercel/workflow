...
<Callout type="info">
To learn how `AbortController` works durably across workflow suspensions, replays, and step boundaries, see [How Cancellation Works](/docs/advanced/cancellation).
</Callout>
...
- A `run_cancelled` event is recorded in the [event log](/docs/advanced/event-sourcing)
...
- [How Cancellation Works](/docs/advanced/cancellation): Hook and stream backing, serialization internals
