...
<Callout type="info">
<LanguageContent value="ts" as="span">See the full API reference for [`createHook()`](/docs/api-reference/workflow/create-hook) for all available options.</LanguageContent><LanguageContent value="py" as="span">Python hook payloads must be Pydantic models or dataclasses that inherit [`BaseHook`](/docs/api-reference/python/base-hook).</LanguageContent>
</Callout>
...
- [`BaseHook` API reference](/docs/api-reference/python/base-hook) - Wait for, inspect, resume, and dispose typed hooks
- [Python getting started](/docs/getting-started/python) - Set up the Python SDK and its workflow registry
