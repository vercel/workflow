...
| `MAX_EVENTS_EXCEEDED` | The run reached the World's per-run event ceiling (25,000 on the Local and Vercel Worlds). Split unbounded loops into [child workflows](/patterns/child-workflows); see [Limits](/docs/configuration/runtime-tuning#limits) |
