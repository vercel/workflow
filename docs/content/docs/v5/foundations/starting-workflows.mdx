...
<LanguageContent value="py">
**Learn more**: [Python getting started](/docs/getting-started/python#starting-a-workflow)
</LanguageContent>
...
- <LanguageContent value="ts" as="span">Check the [`start()` API reference](/docs/api-reference/workflow-api/start) for complete details</LanguageContent><LanguageContent value="py" as="span">Review the [Python guide](/docs/getting-started/python) for Python SDK setup and examples</LanguageContent>
