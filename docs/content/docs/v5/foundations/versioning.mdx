...
Workflow runs are pinned to the deployment that starts them. When a run begins on Vercel, Workflow SDK records the deployment for that run and continues executing the run on that same copy of your code.
