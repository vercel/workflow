...
- [Starter (In-Memory)](https://github.com/mizzle-dev/workflow-worlds/tree/main/packages/starter) (`@workflow-worlds/starter`) - In-memory World template for building custom implementations
