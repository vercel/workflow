...
export async function register() {
  if (process.env.NEXT_RUNTIME !== "edge") {
    ...
    const world = createWorld({
      ...
      queueUrl: process.env.WORKFLOW_QUEUE_URL!,
      stepQueueUrl: process.env.WORKFLOW_STEP_QUEUE_URL!,
      runsTable: process.env.WORKFLOW_RUNS_TABLE!,
      stepsTable: process.env.WORKFLOW_STEPS_TABLE!,
      eventsTable: process.env.WORKFLOW_EVENTS_TABLE!,
      hooksTable: process.env.WORKFLOW_HOOKS_TABLE!,
      streamChunksTable: process.env.WORKFLOW_STREAM_CHUNKS_TABLE!,
      streamBucket: process.env.WORKFLOW_STREAM_BUCKET!,
    });
