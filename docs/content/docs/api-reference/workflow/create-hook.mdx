...
The `using` keyword automatically disposes the hook when it goes out of scope (see [TC39 Explicit Resource Management](https://github.com/tc39/proposal-explicit-resource-management)).
