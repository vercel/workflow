...
The `using` keyword automatically disposes the webhook when it goes out of scope (see [TC39 Explicit Resource Management](https://github.com/tc39/proposal-explicit-resource-management)).
