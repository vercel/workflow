...
<Cards>
    <Card href="/docs/api-reference/workflow/errors/fatal-error" title="FatalError()">
        When thrown, marks a step as failed and the step is not retried.
    </Card>
    <Card href="/docs/api-reference/workflow/errors/retryable-error" title="RetryableError()">
