...
To cancel a run, create a `run_cancelled` event via `world.events.create()` (see [Events](/docs/api-reference/workflow-api/world/events)), or use the CLI or Web UI helpers.
