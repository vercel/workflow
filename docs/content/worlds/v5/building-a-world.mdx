...
In invocation mode that property is ordinary response data. A returned domain
rejection is distinct from a thrown infrastructure failure, which remains
retryable/uncertain according to the transport. Event and response persistence
