...
// instead stretches survival across the bulk of the ~24h message-visibility
// window, so transient outages don't fail otherwise-healthy runs. Going above
// 900s is pointless — VQS clamps it.
