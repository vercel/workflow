  ...
  if (!_dispatcher) {
    _dispatcher = new RetryAgent(
      ...
      }),
      {
        ...
        retryAfter: true,
        // Retry 5xx in-process (genuine transient blips recover fast), but
        // NOT 429. The Vercel firewall issues a challenge as a 429: our
        ...
        // headers — and the queue does the (backed-off) retry instead. This is
        // the long-standing "let 429s pass through" intent.
