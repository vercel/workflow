...
CREATE TABLE "workflow"."workflow_limit_tokens" (
...
CREATE INDEX "workflow_limit_tokens_limit_key_expires_at_index" ON "workflow"."workflow_limit_tokens" USING btree ("limit_key","expires_at");--> statement-breakpoint
