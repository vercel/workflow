...
ALTER TABLE "workflow"."workflow_runs" ADD COLUMN "last_fenced_seq" bigint;--> statement-breakpoint
...
ALTER TABLE "workflow"."workflow_events" ADD COLUMN "fence_count" bigint;--> statement-breakpoint
