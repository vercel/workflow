 ...
 *
 * Note that we were unable to reproduce this issue. This is a fix for the only
 * synthetic way in which we could get the builder to break with the reported
 * error message, and serves as defense-in-depth, since the change is otherwise
 * safe.
 *
