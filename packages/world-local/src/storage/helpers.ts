 ...
 * event again. It is consulted by `hook_received`'s publish-then-verify
 * guard.
 */
 ...
 * marker exists). Mirrors event visibility for tagged worlds: an untagged
 * marker is visible to every tag, a tagged marker only to its own tag.
 */
