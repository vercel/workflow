...
export const cliFlags = {
  ...
  observabilityCwd: Flags.string({
    description:
      'Directory to use when inferring observability configuration (e.g. local data dir, manifest path). Useful when developing the web UI from another repo checkout.',
    required: false,
    default: '',
    env: 'WORKFLOW_OBSERVABILITY_CWD',
    helpGroup: 'Target',
    helpLabel: '--observabilityCwd',
    helpValue: 'PATH',
  }),
