...
var LanguageModel = function(__wf_cls) {
    registerStepFunction("step//./input//LanguageModel.generate", __wf_cls.generate);
    registerStepFunction("step//./input//LanguageModel#doStream", __wf_cls.prototype["doStream"]);
