import { r as require_papaparse } from "./chunk-2NICSRZI.mjs";
import { e as evaluate } from "./chunk-E7HLGBJ6.mjs";
import { r as readFiles } from "./chunk-XTSQ6SVV.mjs";
import { h as hasHelpFlag, s as showHelp } from "./chunk-HAN5425M.mjs";
import { n as __toESM, _ as __name, q as __export, r as __esm, t as __toCommonJS } from "../index.mjs";
...
var import_papaparse$1 = __toESM(require_papaparse());
function parseCsv(input) {
  const result = import_papaparse$1.default.parse(input.trim(), {
    header: true,
    dynamicTyping: true,
    skipEmptyLines: true
  });
...
`;
  ...
  const csv = import_papaparse$1.default.unparse(data, { columns: headers });
  return `${csv.replace(/\r\n/g, "\n")}
`;
}
...
async function cmdFmt(args, ctx) {
  const { cmdView: cmdView2 } = await Promise.resolve().then(function() {
    return xanViewYXRJKE2Y;
  });
...
const xanViewYXRJKE2Y = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  cmdFlatten,
  cmdView
});
