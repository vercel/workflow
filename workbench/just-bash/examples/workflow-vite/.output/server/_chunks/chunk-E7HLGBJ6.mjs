var _a, _b, _c;
import { _ as __name, E as ExecutionLimitError } from "../index.mjs";
...
var BreakError = (_a = class extends Error {
  label;
  partialResults;
  ...
  withPrependedResults(results) {
    return new _a(this.label, [...results, ...this.partialResults]);
  }
}, __name(_a, "BreakError"), _a);
var JqError = (_b = class extends Error {
  value;
  constructor(value) {
