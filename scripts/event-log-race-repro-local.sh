...
already exported is passed through untouched:
  ...
  EVENT_LOG_RACE_REPRO_WAKE_LOOP_ATTEMPTS    EVENT_LOG_RACE_REPRO_HOOK_RESUME_STAGGER_MS
  EVENT_LOG_RACE_REPRO_WAKE_LOOP_WAKES       EVENT_LOG_RACE_REPRO_WAKE_LOOP_HEARTBEAT_MS
  EVENT_LOG_RACE_REPRO_DAG_RUNNER_ATTEMPTS   EVENT_LOG_RACE_REPRO_DAG_RUNNER_WIDTH
  EVENT_LOG_RACE_REPRO_DAG_RUNNER_NODES      EVENT_LOG_RACE_REPRO_DAG_RUNNER_WORKER_EVERY
